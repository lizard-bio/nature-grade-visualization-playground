...
author: "Anikó Meijer, Robbe Neirynck"
date: "25-09-2024"
output:
...
1. **Download Fonts**: Download the two font files from the GitHub repository [Nature Grade Visualization Playground](https://github.com/lizard-bio/nature-grade-visualization-playground/tree/main/FontsToInstall).
...
If you installed the package using `build_vignettes = TRUE`, you can check out the "BioLizardStyleR" vignette, which contains many examples of plots you might want to make in the future, including (interactive) plots for a simple RNA-seq case-control analysis.
...
# 4. Crafting a BioLizard-Styled ggplot
...
## 4.1 Applying the Biolizard theme
...
## 4.2 Adding a BioLizard color palette
...
## 4.3 Adding a BioLizard footer and exporting the plot.
