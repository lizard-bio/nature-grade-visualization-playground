...
treemap::treemap(data, index=c("type_1", "type_2"), vSize="n", type="index",
                 ...
                 fontfamily.title = "rhd", fontfamily.labels = "rhd", fontfamily.legend = "rhd")  #set the lato font
```
...
```{r, fig.width=6}
example_file <- system.file("chicago-nmmaps-custom.csv", package = "BioLizardStyleR")
