...
output: 
   html_document:
    toc: true
    toc_float: true
    css: '`r system.file("css", "biolizardstyle.css", package="BioLizardStyleR")`'
vignette: >
...
The box below shows how to BioLizard-ify a Rmd knit to an HTML using the CSS style file in this package. In the YAML header,
you can set output to html_document with two options: toc: true and toc_float: true.
