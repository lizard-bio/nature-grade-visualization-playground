...
## greens scale
testplot_sequential <- testplot +
  scale_color_biolizard(type = "discrete", scheme = "greens") + 
  lizard_style()
testplot_sequential
...
if (!requireNamespace(c("corrr","forcats", "hexbin"), quietly = TRUE)) {
  # Install the package if it's not installed
  install.packages(c("corrr","forcats", "hexbin"))
}
library(corrr)
library(forcats)
