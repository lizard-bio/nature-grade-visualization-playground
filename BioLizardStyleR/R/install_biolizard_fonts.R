...
#'
#' This function imports BioLizard fonts into R using 'Red Hat Display' as the default font.
#' Users with a different Red Hat Display font installed can adjust the pattern. The function leverages the 'extrafont'
#' package and provides feedback on fonts that match the specified pattern.
#'
#' @param pattern A character string specifying the font file pattern. Default is 'Red Hat Display'.
...
#' }
install_biolizard_fonts <- function(pattern = '[Rr]ed [[Hh]at [Dd]isplay', clearDataBase = FALSE) {
