...
testplot_continuous <- ggplot(data = mtcars, aes(x = hp, y = mpg, color = mpg)) +
  geom_point() +
  labs(
...
test_that("biolizard_pal_qualitative works", {
  ...
  vdiffr::expect_doppelganger("discrete qualitative", testplot_discrete + scale_color_biolizard(type = "discrete", scheme = "qualitative"))
})
...
test_that("biolizard_pal_sequential works", {
  ...
  vdiffr::expect_doppelganger("discrete sequential", testplot_discrete + scale_color_biolizard(type = "discrete", scheme = "sequential"))
  vdiffr::expect_doppelganger("continuous sequential", testplot_continuous + scale_color_biolizard(type = "continuous", scheme = "sequential"))
})
...
test_that("biolizard_pal_divergent works", {
  ...
  vdiffr::expect_doppelganger("discrete divergent", testplot_discrete + scale_color_biolizard(type = "discrete", scheme = "divergent"))
  vdiffr::expect_doppelganger("continuous divergent", testplot_continuous + scale_color_biolizard(type = "continuous", scheme = "divergent"))
})
